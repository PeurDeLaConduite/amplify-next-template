...
export type AuthorEditableKeys = "authorName" | "bio" | "email" | "avatar" | "order";

export const authorConfig = {
    model: "Author" as const,

    fields: ["authorName", "bio", "email", "avatar", "order"] as AuthorEditableKeys[],
    ...
    toInput(form: Partial<Record<AuthorEditableKeys, unknown>>) {
        const f = form as Partial<
            Pick<AuthorType, "authorName" | "bio" | "email" | "avatar" | "order">
        >;
        const input = {
